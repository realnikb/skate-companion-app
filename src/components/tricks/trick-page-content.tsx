    ...
    return (
        <main className={styles.main}>
            ...
            <section className={styles.content} aria-label={`${trick.name} trick guide`}>
                <TrickViewer trick={trick} tricks={tricks} category={category} categories={categories} controllerPlatform={controllerPlatform} stance={stance} previousTrick={previousTrick} nextTrick={nextTrick} />
            </section>
        </main>
    );
}
