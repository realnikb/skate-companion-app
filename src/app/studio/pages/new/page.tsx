      ...
      <StudioForm kind="new-page">
        <section className={`${styles.panel} ${styles.detailsPanel}`}>
          ...
          <div className={styles.field}>
            ...
            <input
              id="eyebrow"
              name="eyebrow"
              placeholder="About Skate Companion"
            />
          </div>
          <div className={styles.field}>
          ...
          <div className={styles.field}>
            ...
            <textarea
              className={styles.pageBodyEditor}
              id="body"
              name="body"
              rows={22}
              placeholder={
                "## Section heading\n\nWrite paragraphs here.\n\n- Add list items with a dash"
              }
            />
          </div>
        </section>
        <aside className={`${styles.panel} ${styles.publishingPanel}`}>
          ...
          <p className={styles.settingsNote}>
            New pages begin as drafts. After creation, review the public preview
