...
export const metadata: Metadata = {
  ...
  description:
    "Sign in to sync your Skate Companion preferences, favourites, and lines.",
...
export default async function SignInPage({
  ...
  return (
    <main className={styles.loginPage}>
      <Link
        className={styles.loginWordmark}
        href="/"
      ...
      <section className={styles.loginCard}>
        ...
        <p className={styles.switchAuth}>
          New to Skate Companion?{" "}
          <Link href="/account/sign-up">Create a free account</Link>
        </p>
      </section>
