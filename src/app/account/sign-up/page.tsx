...
export const metadata: Metadata = {
  ...
  description:
    "Create a free Skate Companion account to sync your preferences, favourites, and lines.",
    ...
    <main className={styles.page}>
      <section className={styles.card}>
        <Link
          ...
          href="/"
          aria-label="Back to Skate Companion"
        >
          <Image
            src="/skate-logo.webp"
            alt="Skate"
        ...
        <p className={styles.intro}>
          Create your free account and keep your skating setup synced wherever
          you play.
        </p>
        ...
        <div className={styles.trust}>
          <LockKeyhole />
          <span>
            Secure, passwordless sign-up. We’ll only email you to access your
            account.
          </span>
        </div>
      </section>
      <aside className={styles.art} aria-hidden="true">
        <div className={styles.artLabel}>
          Your companion on and off the board.
        </div>
        <strong>
        ...
        <ul>
          <li>
            <Check /> Save favourite tricks
          </li>
          <li>
            <Check /> Build and keep session lines
          </li>
          <li>
            <Check /> Sync your stance and controls
          </li>
        </ul>
