...
export type SocialPost = { id: string; body: string; type: string; imageUrl?: string; videoUrl?: string; location?: string; mapPin?: { mapName: string; x: number; y: number }; tags: { id: string; name: string; handle?: string; crewSlug?: string; kind: "skater" | "crew" }[]; createdAt: string; likes: number; comments: number; author: { name: string; handle: string; crewSlug?: string; initials: string } };
