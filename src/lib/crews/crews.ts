...
export const crews: Crew[] = [
    {
        ...
        location: "UK · EU", platform: "Cross-platform", style: ["Realism", "Filming"], languages: [{ code: "en", name: "English", flag: "🇬🇧" }, { code: "fr", name: "French", flag: "🇫🇷" }], recruitment: "recruiting",
    ...
    },
    {
        ...
        style: ["Trick lines", "Technical"], languages: [{ code: "en", name: "English", flag: "🇺🇸" }, { code: "es", name: "Spanish", flag: "🇲🇽" }], recruitment: "invite-only", memberCount: 8, followerCount: "1.9k", accent: "#ff645d",
    ...
    },
    {
        ...
        style: ["Realism", "Cinematic"], languages: [{ code: "en", name: "English", flag: "🇬🇧" }, { code: "nl", name: "Dutch", flag: "🇳🇱" }], recruitment: "closed", memberCount: 6, followerCount: "4.1k", accent: "#eecb57",
