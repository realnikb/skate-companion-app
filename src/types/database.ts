    ...
    public: {
        Tables: {
            ...
            crews: {
                ...
                Insert:{id?:string;owner_id?:string|null;slug:string;name:string;tagline?:string|null;description?:string|null;logo_path:string;banner_path?:string|null;primary_color?:string;location?:string|null;platform?:string|null;styles?:string[];languages?:string[];recruitment_status?:"recruiting"|"invite-only"|"closed";recruitment_details?:string|null;is_published?:boolean;created_at?:string;updated_at?:string};
                Update:{id?:string;owner_id?:string|null;slug?:string;name?:string;tagline?:string|null;description?:string|null;logo_path?:string;banner_path?:string|null;primary_color?:string;location?:string|null;platform?:string|null;styles?:string[];languages?:string[];recruitment_status?:"recruiting"|"invite-only"|"closed";recruitment_details?:string|null;is_published?:boolean;created_at?:string;updated_at?:string};Relationships:[];
            };
            ...
            social_posts:{Row:{id:string;author_id:string;crew_id:string|null;body:string;post_type:"post"|"session"|"spot"|"video";image_path:string|null;media_type:"image"|"video"|null;external_video_url:string|null;location:string|null;session_at:string|null;map_id:string|null;map_position:Json|null;likes_count:number;comments_count:number;is_published:boolean;created_at:string;updated_at:string};Insert:{id?:string;author_id:string;crew_id?:string|null;body:string;post_type?:"post"|"session"|"spot"|"video";image_path?:string|null;media_type?:"image"|"video"|null;external_video_url?:string|null;location?:string|null;session_at?:string|null;map_id?:string|null;map_position?:Json|null;likes_count?:number;comments_count?:number;is_published?:boolean;created_at?:string;updated_at?:string};Update:{id?:string;author_id?:string;crew_id?:string|null;body?:string;post_type?:"post"|"session"|"spot"|"video";image_path?:string|null;media_type?:"image"|"video"|null;external_video_url?:string|null;location?:string|null;session_at?:string|null;map_id?:string|null;map_position?:Json|null;likes_count?:number;comments_count?:number;is_published?:boolean;created_at?:string;updated_at?:string};Relationships:[]};
            social_post_media:{Row:{id:string;post_id:string;storage_path:string;media_type:"image"|"video";position:number;created_at:string};Insert:{id?:string;post_id:string;storage_path:string;media_type:"image"|"video";position:number;created_at?:string};Update:{id?:string;post_id?:string;storage_path?:string;media_type?:"image"|"video";position?:number;created_at?:string};Relationships:[]};
            social_post_likes:{Row:{post_id:string;user_id:string;created_at:string};Insert:{post_id:string;user_id:string;created_at?:string};Update:{post_id?:string;user_id?:string;created_at?:string};Relationships:[]};
            social_post_comments:{Row:{id:string;post_id:string;user_id:string;body:string;media_path:string|null;media_type:"image"|"video"|null;created_at:string;updated_at:string};Insert:{id?:string;post_id:string;user_id:string;body:string;media_path?:string|null;media_type?:"image"|"video"|null;created_at?:string;updated_at?:string};Update:{id?:string;post_id?:string;user_id?:string;body?:string;media_path?:string|null;media_type?:"image"|"video"|null;created_at?:string;updated_at?:string};Relationships:[]};
            social_post_user_tags:{Row:{post_id:string;user_id:string;created_at:string};Insert:{post_id:string;user_id:string;created_at?:string};Update:{post_id?:string;user_id?:string;created_at?:string};Relationships:[]};
            social_post_crew_tags:{Row:{post_id:string;crew_id:string;created_at:string};Insert:{post_id:string;crew_id:string;created_at?:string};Update:{post_id?:string;crew_id?:string;created_at?:string};Relationships:[]};
            skate_maps: {
