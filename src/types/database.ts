    ...
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          bio: string | null;
          preferred_controller: "xbox" | "playstation";
          stance: "regular" | "goofy";
          playstation_gamertag: string | null;
          xbox_gamertag: string | null;
          ea_id: string | null;
          steam_gamertag: string | null;
      ...
      crews: {
        Row: {
          ...
          styles: string[];
          languages: string[];
          recruitment_status: "recruiting" | "invite-only" | "closed";
      ...
      crew_discord_integrations: {
        Row: {
          ...
          approximate_online_count: number;
      ...
      social_posts: {
        Row: {
          ...
          crew_id: string | null;
          body: string;
          post_type: "post" | "session" | "spot" | "video";
      ...
      social_post_user_tags: {
        Row: { post_id: string; user_id: string; created_at: string };
        Insert: { post_id: string; user_id: string; created_at?: string };
        Update: { post_id?: string; user_id?: string; created_at?: string };
        Relationships: [];
      };
      social_post_crew_tags: {
        Row: { post_id: string; crew_id: string; created_at: string };
        Insert: { post_id: string; crew_id: string; created_at?: string };
        Update: { post_id?: string; crew_id?: string; created_at?: string };
        Relationships: [];
      };
      skate_maps: {
        Row: {
