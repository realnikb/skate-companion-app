...
export type Database = {
    public: {
        Tables: {
            ...
            social_post_comments:{Row:{id:string;post_id:string;user_id:string;body:string;created_at:string;updated_at:string};Insert:{id?:string;post_id:string;user_id:string;body:string;created_at?:string;updated_at?:string};Update:{id?:string;post_id?:string;user_id?:string;body?:string;created_at?:string;updated_at?:string};Relationships:[]};
