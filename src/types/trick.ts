...
export type StickPathPreset = { id: string; slug: string; name: string; points: StickPoint[] };

export type NormalizedControlInput =
    | { type: "button"; control: ControlButton; action: "press" | "hold" | "release"; join?: "and" | "or" }
    | { type: "stick"; stick: "left" | "right"; action: "flick" | "scoop" | "scoop-then-flick" | "rotate" | "hold" | "release"; join?: "and" | "or"; pathId?: string; path: { points: StickPoint[]; closed?: boolean } };

export type ControlStep = { inputs: NormalizedControlInput[] };
export type ControlVariant = { context?: string; stanceBehavior: "mirror" | "fixed"; steps: ControlStep[] };
export type TrickControls = { version: 2; authoredStance: SkaterStance; variants: ControlVariant[] };
